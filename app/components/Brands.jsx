            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        We've had the privilege of working with innovative
                            ...
                            {infiniteBrands.map((brand, index) => (
                                ...
                                >
                                    <img
                                        ...
                                        alt={`${brand.name} logo`}
                                        className="max-h-12 max-w-full object-contain grayscale dark:brightness-125 dark:contrast-125 hover:grayscale-0 hover:brightness-125 hover:contrast-125 transition-all duration-300"
                                        draggable={false}
                                        loading="lazy"
                                    />
                                </div>
