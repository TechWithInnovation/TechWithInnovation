...
import { ourServices } from "@/public/data";
...
const Services = () => {
  ...
  const scrollToIndex = (indexOrUpdater) => {
    ...
    const maxIndex = ourServices.length - 1;
    const newIndex =
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      scrollToIndex((prev) =>
        currentIndex >= ourServices.length - 1 ? 0 : currentIndex + 1
      );
    }, 3000);
    return () => clearInterval(interval);
  }, [currentIndex, ourServices.length]);
  ...
  return (
    <section id="services" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-mono mb-4">Our Services</h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Tailored digital solutions built to elevate your business presence.
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="flex justify-center items-center gap-4 mt-6">
            ...
            <Button
              ...
              onClick={handleNext}
              className="rounded-full hover:bg-primary hover:text-primary-foreground bg-transparent"
              disabled={currentIndex === ourServices.length - 1}
            >
