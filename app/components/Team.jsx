...
import { IconBrandLinkedin, IconBrandGithub, IconExternalLink, IconBrandTwitter, IconBrandInstagram } from '@tabler/icons-react'
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        The talented individuals behind our innovative solutions. Each bringing unique expertise and passion to
                        every project.
                    </p>
                </motion.div>
                <motion.div
                            ...
                            <Card className="overflow-hidden group hover:shadow-xl transition-all duration-300 h-full hover:-translate-y-2">
                                ...
                                <CardContent className="p-4 md:p-6">
                                    <div className="text-center mb-4">
                                        <h3 className="text-lg md:text-xl font-mono mb-1">{member.name}</h3>
                                        <p className="text-primary text-sm font-bold">{member.role}</p>
                                    </div>

                                    <p className="text-muted-foreground text-xs md:text-sm mb-4 line-clamp-3">{member.bio}</p>
